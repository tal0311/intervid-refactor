...
const gTrans = {
  ...
  'watch-video-and-evaluate-msg': {
    en:
      'Watch received video interviews at your convenience, review candidates information and evaluate their performance',
  ...
  'contect-with-leading-candidates': {
    en:
      'Contact with your leading applicants, and save time by schedule frontal meeting only with the icing on the cake.',
    he: 'צור קשר עם המועמדים המובילים שלך, וחסוך זמן על ידי קביעת פגישה פרונטלית רק עם המועמדים המובילים.',
  },
  'publish-or-send-link': {
    en:
      'Share a job interview invitation through your favorite contact channels - direct messages, social networks or an embedded invitation on your site',
    he:
      'ניתן לשתף את ההזמנה לראיון עבודה דרך ערוצי התקשורת המועדפים עליך - הודעות ישירות, רשתות חברתיות או קישור באתר שלך.',
  },
  ...
  'send-iterview-invitation-to-candidates-msg': {
    en:
      'Send the interview invitation link to any potential candidate. Click the button below to copy the interview link',
  ...
  'record-and-play-a-short-video-sample-msg': {
    ...
    he:
      'הקלט וצפה בווידאו קצר שלך בו אתה מדבר על מנת לראות כיצד אתה נראה ונשמע. אף אחד לא יצפה בסרטון הזה מלבדך והוא לא מוקלט או נשמר בשום מקום',
  },
  ...
  'video-and-audio-check-msg': {
    en:
      'Center your face in the frame and talk when video and audio are captured correctly, the camera and microphone indicators shall change from red to',
    he:
      'יש למרכז את הפנים בפריים ולדבר. כאשר הווידאו והאודיו נלכדים בצורה נכונה, מחווני המצלמה והמיקרופון ישתנו מאדום ל',
  },
  green: {
    en: 'GREEN',
    he: 'ירוק',
  ...
  CAMERA_BUSY_TXT: {
    en:
      "Camera can't be detected or currently being used by another application: Please make sure that your camera is connected and not in use",
    he:
  ...
  DENIED_CAM_ACCESS_DESC_FIREFOX: {
    en:
      'In the Menu bar at the top of the screen, click Firefox and select Preferences > Click Privacy & Security from the left menu > Scroll down to the Permissions section > Click the Settings > Use the Allow/Block selector to change permission for the website',
    he:
      'לחץ על הפיירפוקס בתפריט בראש המסך > העדפות > פרטיות ואבטחה > לחץ על "הגדרות" בקטגוריית ההרשאות > אשר הרשאה עבור האתר',
  },
  ...
  DENIED_MIC_ACCESS_DESC_FIREFOX: {
    en:
      'In the Menu bar at the top of the screen, click Firefox and select Preferences > Click Privacy & Security from the left menu > Scroll down to the Permissions section > Click the Settings > Use the Allow/Block selector to change permission for the website',
    he:
      'לחץ על פיירפוקס בתפריט בראש המסך > העדפות > פרטיות ואבטחה > לחץ על "הגדרות" בקטגוריית ההרשאות > אשר הרשאה עבור האתר',
  },
