<template>
  <section class="record-details">
    <article
      v-if="record.meta.applicant && record.meta.applicant.info"
      class="applicant-info"
    >
      <img
        v-if="record.meta.applicant.info.imgUrl"
        :src="record.meta.applicant.info.imgUrl"
        alt="applicant-avatar"
      />
      <div class="user-info-item">
        <span>Applicant Id:</span> {{ record.meta.applicant.id }}
      </div>
      <div class="user-info-item">
        <span>First Name:</span> {{ record.meta.applicant.info.fName }}
      </div>
      <div class="user-info-item">
        <span>Last Name:</span> {{ record.meta.applicant.info.lName }}
      </div>
      <div class="user-info-item">
        <span>Email:</span> {{ record.meta.applicant.info.email }}
      </div>
    </article>

    <article v-else-if="record.meta.user" class="user-info">
      <img
        v-if="record.meta.user.imgUrl"
        :src="record.meta.user.imgUrl"
        alt="applicant-avatar"
      />
      ...
      <div class="user-info-item">
        <span>Permission:</span> {{ permission }}
      </div>
    </article>
    ...
    <article class="error-info">
      ...
      <div :title="message" class="error-info-item">
