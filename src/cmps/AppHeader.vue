<template>
  <header class="main-header">
    <div
      ...
      :class="isSmallContainer ? 'narrow-container' : 'container'"
    >
      <div class="logo-container">
        <RouterLink
          class="logo"
          :to="loggedInUser ? '/backoffice/applicant' : '/'"
        >
      ...
      <div class="btn-container">
        <div v-if="isJobEdit && jobToEdit" class="job-actions-container">
          ...
          <i v-if="jobToEdit._id" class="material-icons" @click="openPreview"
            >visibility</i
          >
          <button
            class="send-btn"
            :class="[
              {
                disabled:
                  !jobToEdit._id || (jobEditErrors && jobEditErrors.length),
              },
