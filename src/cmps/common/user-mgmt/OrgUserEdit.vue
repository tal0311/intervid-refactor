  ...
  <div class="org-user-edit">
    <h2>
      {{
        userToEdit
          ? getTrans("edit-user")
          : getTrans("add-user-to-organization")
      }}
            ...
            <div class="advanced-perms">
              ...
              >
                <checkbox
                  ...
                  :disabled="
                    isDefaultSelect(advancedPerm) || advancedPerm.isBlocked
                  "
                ></checkbox>
...
export default {
  ...
  methods: {
    ...
    isAdvancedSelected(advancedPerm) {
      return (
        this.isDefaultSelect(advancedPerm) ||
        this.user.advancedPrm[advancedPerm.name]
      );
    },
    ...
    onToggleAdvancedPerm(advancedPermKey) {
      this.user.advancedPrm[advancedPermKey] =
        !this.user.advancedPrm[advancedPermKey];
    },
