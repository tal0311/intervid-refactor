...
async function getScreenStream() {
  ...
  gScreenStream = await navigator.mediaDevices.getDisplayMedia(displayMediaOptions)
  return gScreenStream
}

async function getScreenRecorder() {
  if (gScreenRecorder && gScreenRecorder.state !== 'inactive') return gScreenRecorder
