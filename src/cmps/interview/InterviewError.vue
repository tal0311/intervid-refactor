<template>
  <section class="interview-error">
    ...
    <no-mobile-screen-share
      v-else-if="interviewErr.type === 'NO_MOBILE_SCREEN_SHARE'"
    />
    <not-found
      v-else-if="interviewErr.type === 'INTERVIEW_NOT_FOUND'"
      :msg="getTrans('interview-not-available')"
    />
  </section>
</template>
