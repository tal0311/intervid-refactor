...
export function getSortableHeaders(path) {
...
export const initialState = {
  app: {
    modal: {type: '', data: null, isDarkScreen: false},
    alertData: null,
    isMobile: true,
    browser: {name: 'chrome', version: '112.0.0', os: 'Windows 10', type: 'browser'},
    progressBar: {isShown: false, steps: [], currStepIdx: null},
    lang: 'en',
    cancelRequestMap: {},
  },
  user: {
  ...
  auth: {isAuthing: false, authError: '', refreshTokenPrm: null},
  job: {
    jobs: null,
    jobToEdit: null,
    prevJobToEdit: null,
  ...
  template: {templates: [], template: null, defaultTemplates: [], isFetching: false},
  applicant: {
    job: null,
    applicant: null,
    isFetching: false,
  ...
  activity: {activities: [], totalActivityCount: 0, isFetching: false},
}
