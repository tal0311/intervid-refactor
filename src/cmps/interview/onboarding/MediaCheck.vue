  ...
  <section class="media-check">
    <div class="check-container">
      <div class="video-wrapper">
        ...
        <div v-if="currStep === 1" class="face-helper" :class="{success: isFaceReady}">
  ...
  computed: {
    ...
    microphoneStatus() {
      ...
      if (errs.length) {
        ...
        return {txt: this.getTrans('MIC_LOW_VOLUME_TITLE'), isError: true, error: videoErrorMap.MIC_LOW_VOLUME}
    ...
    cameraStatus() {
      ...
      if (errs.length)
        ...
        return {txt: this.getTrans('NOT_RECOGNIZED_TITLE'), isError: true, error: videoErrorMap.NOT_RECOGNIZED}
      else return {txt: 'OK', isError: false}
    },
    ...
    connectionStatus() {
      ...
      if (errs.length) return {txt: this.getTrans(`${errs[0].type}_TITLE`), isError: true, error: errs[0]}
      else return {txt: 'OK', isError: false}
    },
